...
#include <QThread>
#include <QSettings>
#include "protocol_VMA/vma_controller.h"
#include "math.h"
#include <qmath.h>
#include <QTime>
#include <QDebug>
...
protected:
    ...
    MS5837* ps = nullptr;
    power_Mode pMode;
    Manipulator_controller* manipulatorProtocol = nullptr;
    //обмен с пультом
...
signals:
    void requestDepth(); // Сигнал для запроса глубины
